        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _a = false;
                    row = _d;
                    if ((row["STATUS"] || "").trim().toUpperCase() === "ACTIVE") {
                        entry = {
                ...
                case 12:
                    ...
                    console.log("Done! Wrote ".concat(results.length, " active records to ").concat(outputPath));
                    return [2 /*return*/];
            }
        });
    });
...
convertTabDelimitedToJson(
    'e:\\GitHub\\ClearView\\ClearView\\app\\api\\verify\\connecticut\\Veterinarian.txt',
    'e:\\GitHub\\ClearView\\ClearView\\app\\api\\verify\\connecticut\\VET.json'
);
