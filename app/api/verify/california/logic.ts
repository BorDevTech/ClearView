...
export async function verify({
  ...
  formData.append("boardCode", "10");
  formData.append("licenseType", "10");
  ...
  const res = await fetch(`/api/verify/california/?${queryParams.toString()}`, {
    method: "POST",
    headers: {
